...
#define CALC_VERSION 2.8 //not used
...
//Moving Violations
#define ILLEGAL_PARKING_FINE 250
#define ILLEGAL_UTURN_FINE 500
#define IMPROPER_LANE_CHANGE_FINE 500
#define DRIVING_WITH_NO_HEADLIGHTS_FINE 500
#define UNROADWORTHY_VEHICLE_FINE 1500
#define BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE 500
#define BROKEN_WINDSHIELD_FINE 500
#define FAILURE_TO_YIELD_TO_EMERGENCY_VEHICLE_FINE 1000
#define IMPEDING_THE_FLOW_OF_TRAFFIC_FINE 500
#define SPEEDING_FINE 1000
#define HABITUAL_SPEEDING_FINE 3000 //Gone?
#define HABITUAL_SPEEDING_JAIL 10   //Gone?
#define RUNNING_RED_LIGHT_STOP_SIGN_FINE 750
#define HABITUAL_RUNNING_RED_LIGHT_STOP_SIGN_FINE 4000  //Gone?
#define HABITUAL_RUNNING_RED_LIGHT_STOP_SIGN_JAIL 15  //Gone?
#define DRIVING_UNDER_THE_INFLUENCE_FINE 5000
#define DRIVING_UNDER_THE_INFLUENCE_JAIL 10
#define STUNT_DRAG_STREET_RACING_FINE 2500
#define STUNT_DRAG_STREET_RACING_JAIL 3
#define DRIVING_WITHOUT_A_LICENSE_FINE 2000
#define DRIVING_WITHOUT_A_LICENSE_JAIL 7
#define DRIVING_THE_WRONG_WAY_FINE 1000
#define HIT_AND_RUN_FINE 5000
#define HIT_AND_RUN_JAIL 10
#define CARELESS_DRIVING_FINE 7500
#define CARELESS_DRIVING_JAIL 7


//Misdemeanors
#define HARRASMENT_FINE 500
#define HARRASMENT_JAIL 7
#define PUBLIC_DAMAGE_FINE 500
#define PUBLIC_DAMAGE_JAIL 3
...
#define PUBLIC_INTOXICATION_FINE 500
#define PUBLIC_INTOXICATION_JAIL 2
#define OBSTRUCTION_FINE 1000
#define OBSTRUCTION_JAIL 10
#define DISTURBING_THE_PEACE_FINE 1000
#define DISTURBING_THE_PEACE_JAIL 8
#define DISCHARGE_OF_A_FIREARM_FINE 1500
#define DISCHARGE_OF_A_FIREARM_JAIL 15
#define ATTEMPTED_ROBBERY_FINE 500
#define ATTEMPTED_ROBBERY_JAIL 15
#define ATTEMPTED_GTA_FINE 500
#define ATTEMPTED_GTA_JAIL 15
#define BOOTLEG_ALCOHOL_FINE 1000
#define BOOTLEG_ALCOHOL_JAIL 15
#define POSSESSION_OF_RAW_ILLEGAL_DRUGS_FINE 1000
#define POSSESSION_OF_RAW_ILLEGAL_DRUGS_JAIL 5
#define LOITERING_FINE 1000
#define LOITERING_JAIL 3
#define ACCESSORY_TO_A_CRIME_FINE 500
#define ACCESSORY_TO_A_CRIME_JAIL 10
#define ASSAULT_FINE 1000
#define ASSAULT_JAIL 10
#define ELUDING_POLICE_ON_FOOT_FINE 500
#define ELUDING_POLICE_ON_FOOT_JAIL 10
#define RESISTING_ARREST_FINE 500
#define RESISTING_ARREST_JAIL 10
#define ANIMAL_ABUSE_FINE 500
#define ANIMAL_ABUSE_JAIL 8
#define MISUSE_OF_911_FINE 500
#define MISUSE_OF_911_JAIL 3
#define BRIBERY_FINE 2500
#define BRIBERY_JAIL 5
#define CONTEMPT_OF_COURT_FINE 500
#define CONTEMPT_OF_COURT_JAIL 5
#define TAMPERING_WITH_EVIDENCE_FINE 500
#define TAMPERING_WITH_EVIDENCE_JAIL 6
#define EXTORTION_FINE 5000
#define EXTORTION_JAIL 5
#define FAILURE_TO_PROVIDE_DRIVERS_LICENSE_FINE 500
#define FAILURE_TO_PROVIDE_DRIVERS_LICENSE_JAIL 2
#define LEVEL_1_ILLEGAL_WEAPON_FINE 1000
#define LEVEL_1_ILLEGAL_WEAPON_JAIL 10
#define LEVEL_2_ILLEGAL_WEAPON_FINE 3000
#define LEVEL_2_ILLEGAL_WEAPON_JAIL 15
#define INTENT_TO_MANUFACTURER_FINE 1000
#define INTENT_TO_MANUFACTURER_JAIL 5
#define GANG_ENHANCEMENT_ONE 5000

//Felonys
#define STALKING_FINE 2500
...
#define RECKLESS_DRIVING_WHILE_EVADING_FINE 10000
#define RECKLESS_DRIVING_WHILE_EVADING_JAIL 20
#define POSSESSION_OF_A_STOLEN_VEHICLE_FINE 2500
#define POSSESSION_OF_A_STOLEN_VEHICLE_JAIL 10
#define AGGRAVATED_ASSAULT_FINE 2500
#define AGGRAVATED_ASSAULT_JAIL 10
#define ASSUALT_ON_A_CITY_WORKER_FINE 3000
#define ASSUALT_ON_A_CITY_WORKER_JAIL 10
#define ATTEMPTED_MURDER_OF_A_CIVILIAN_FINE 10000
#define ATTEMPTED_MURDER_OF_A_CIVILIAN_JAIL 15
#define ATTEMPTED_MURDER_OF_A_CITY_WORKER_FINE 25000
#define ATTEMPTED_MURDER_OF_A_CITY_WORKER_JAIL 60
#define MANSLAUGHTER_FINE 5000
#define MANSLAUGHTER_JAIL 30
#define UNARMED_ROBBERY_FINE 1000
#define UNARMED_ROBBERY_JAIL 8
#define ARMED_ROBBERY_FINE 1000
#define ARMED_ROBBERY_JAIL 10
#define DRUG_TRAFFICKING_FINE 1250
#define DRUG_TRAFFICKING_JAIL 10
#define INTENT_TO_DISTRIBUTE_FINE 1000
#define INTENT_TO_DISTRIBUTE_JAIL 5
#define FAILURE_TO_APPEAR_FINE 1000
#define FAILURE_TO_APPEAR_JAIL 25
#define LEVEL_3_ILLEGAL_WEAPON_FINE 5000
#define LEVEL_3_ILLEGAL_WEAPON_JAIL 20
#define UNARMED_GTA_FINE 2500
#define UNARMED_GTA_JAIL 5
#define ARMED_GTA_FINE 5000
#define ARMED_GTA_JAIL 10
#define CONTRABAND_TRAFFICKING_FINE 2500
#define CONTRABAND_TRAFFICKING_JAIL 10
#define RECKLESS_DRIVING_FINE 5000
#define RECKLESS_DRIVING_JAIL 20
#define GANG_ENHANCEMENT_TWO 10000
#define DRIVING_WITH_SUSPENDED_LICENSE_FINE 50000
#define DRIVING_WITH_SUSPENDED_LICENSE_JAIL 30


void movingViolations(int *, int *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, int *, int *);
void misdemeanors(int *, int *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, int *, int *);
void felonys(int *, int *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, int *, int *, int *);
void jailCell(int *);
void manuallySet(int *, int *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, int *, int *);
void removeCharge(int *, int *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, int *, int *, int *, int *);
void printCodes(int *, int *, int *, int *, int *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, int *, int *, int *);
...
int main()
{
	...
	do
	{
		...
		else if (jailTime < MAX_JAIL_TIME)
		{
		...
		{
		case 1:
			movingViolations(&fine, &jailTime, chargeA, chargeB, chargeC, chargeD, chargeE, chargeF, chargeG, chargeH, chargeI, chargeJ, chargeK, chargeL, chargeM, chargeN, chargeO, &cCount, &jail);
			space = 1;
			break;
		case 2:
			misdemeanors(&fine, &jailTime, chargeA, chargeB, chargeC, chargeD, chargeE, chargeF, chargeG, chargeH, chargeI, chargeJ, chargeK, chargeL, chargeM, chargeN, chargeO, &cCount, &jail);
			space = 1;
			break;

		case 3:
			felonys(&fine, &jailTime, chargeA, chargeB, chargeC, chargeD, chargeE, chargeF, chargeG, chargeH, chargeI, chargeJ, chargeK, chargeL, chargeM, chargeN, chargeO, &cCount, &jail, &dirtyMoney);
			space = 1;
			break;
		...
		case 5:
			...
			if (cCount == 0)
			{
				...
				printCodes(&id, &cService, &cCount, &fine, &jailTime, chargeA, chargeB, chargeC, chargeD, chargeE, chargeF, chargeG, chargeH, chargeI, chargeJ, chargeK, chargeL, chargeM, chargeN, chargeO, &jail, &removed, &dirtyMoney);
			}
		...
		case 6:
			space = 1;
			removeCharge(&fine, &jailTime, chargeA, chargeB, chargeC, chargeD, chargeE, chargeF, chargeG, chargeH, chargeI, chargeJ, chargeK, chargeL, chargeM, chargeN, chargeO, &cCount, &jail, &removed, &dirtyMoney);
			if (cCount == 0)
			{
				printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
			}
		...
		case 7:
			...
			space = 1;
			manuallySet(&fine, &jailTime, chargeA, chargeB, chargeC, chargeD, chargeE, chargeF, chargeG, chargeH, chargeI, chargeJ, chargeK, chargeL, chargeM, chargeN, chargeO, &cCount, &jail);
			if (cCount == 0)
			{
				printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
			}
		...
		case 99:
			space = 99;
			printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n-----------------------------------------------------");
			printf("\n +PROGRAM INFOMATION+\n WaCKPaCK PD FineCalc Version 2.8\n www.thewackpackrp.com\n Release: 08/15/2019\n Devoloped by: P_O_G (Discord: P_O_G#2222)");
			printf("\n-----------------------------------------------------\n(Copied to Clipboard)\n\n");

			/////////////////////////////////////////////Copy to clipboard
			char codeToCopy[420];
			sprintf(codeToCopy, "+PROGRAM INFOMATION+\r\n WaCKPaCK PD FineCalc Version 2.7\r\n www.thewackpackrp.com\r\n Release: 06/10/2019\n Devoloped by: P_O_G (Discord: P_O_G#2222)");
...
void movingViolations(int *ptr_fine, int *ptr_jailTime, char chargeA[50], char chargeB[50], char chargeC[50], char chargeD[50], char chargeE[50], char chargeF[50], char chargeG[50], char chargeH[50], char chargeI[50], char chargeJ[50], char chargeK[50], char chargeL[50], char chargeM[50], char chargeN[50], char chargeO[50], int *ptr_cCount, int *ptr_jail)
{
	//Color Stuff
	HANDLE hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
	CONSOLE_SCREEN_BUFFER_INFO consoleInfo;
	...
	do
	{
		printf(
			...
			"\n| 10. Speeding                                 |"
			"\n| 11. Running Red Light/Stop Sign              |"
		...
		case 6:
			...
			if (strcmp(chargeA, "") == 0)
			{
				strcpy(chargeA, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeB, "") == 0)
			{
				strcpy(chargeB, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeC, "") == 0)
			{
				strcpy(chargeC, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeD, "") == 0)
			{
				strcpy(chargeD, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeE, "") == 0)
			{
				strcpy(chargeE, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeF, "") == 0)
			{
				strcpy(chargeF, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeG, "") == 0)
			{
				strcpy(chargeG, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeH, "") == 0)
			{
				strcpy(chargeH, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeI, "") == 0)
			{
				strcpy(chargeI, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeJ, "") == 0)
			{
				strcpy(chargeJ, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeK, "") == 0)
			{
				strcpy(chargeK, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeL, "") == 0)
			{
				strcpy(chargeL, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeM, "") == 0)
			{
				strcpy(chargeM, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeN, "") == 0)
			{
				strcpy(chargeN, "|| Broken Head / Tail Light || ");
			}
			else if (strcmp(chargeO, "") == 0)
			{
				strcpy(chargeO, "|| Broken Head / Tail Light || ");
			}
			*ptr_cCount = *ptr_cCount + 1;
			*ptr_fine = *ptr_fine + BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			break;
		...
		case 13:
			...
			*ptr_jailTime = *ptr_jailTime + STUNT_DRAG_STREET_RACING_JAIL;
			break;
		...
		case 16:
			...
			*ptr_jailTime = *ptr_jailTime + DRIVING_WITHOUT_A_LICENSE_JAIL;
			break;
...
void misdemeanors(int *ptr_fine, int *ptr_jailTime, char chargeA[50], char chargeB[50], char chargeC[50], char chargeD[50], char chargeE[50], char chargeF[50], char chargeG[50], char chargeH[50], char chargeI[50], char chargeJ[50], char chargeK[50], char chargeL[50], char chargeM[50], char chargeN[50], char chargeO[50], int *ptr_cCount, int *ptr_jail)
{
	//Color Stuff
	HANDLE hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
	CONSOLE_SCREEN_BUFFER_INFO consoleInfo;
	...
	do
	{
		printf(
			...
			"\n| 14. Assault                               |"
			"\n| 15. Eluding Police On Foot                |"
			"\n| 16. Resisting Arrest                      |"
			"\n| 17. Animal Abuse                          |"
			"\n| 18. Misuse of 911                         |"
			"\n| 19. Bribery                               |"
			"\n| 20. Contempt of Court                     |"
			"\n| 21. Tampering With Evidence               |"
			"\n| 22. Failure To Provide Drivers License    |"
			"\n| 23. Intent to Manufacturer                |"
			"\n| 24. Level 1 Illegal Weapon                |"
			"\n| 25. Level 2 Illegal Weapon                |"
			"\n| 26. Gang Enhancment 1                     |"
			"\n|                                           |"
			"\n| ");
		SetConsoleTextAttribute(hConsole, FOREGROUND_GREEN | FOREGROUND_INTENSITY);
		printf("0. BACK\t\t\t\t    ");
		...
		case 1:
			...
			*ptr_jailTime = *ptr_jailTime + HARRASMENT_JAIL;
			break;
		case 2:
			//Public Damage
			if (strcmp(chargeA, "") == 0)
		...
		case 12:
			...
			*ptr_jailTime = *ptr_jailTime + LOITERING_JAIL;
			break;
		...
		case 15:
			...
			if (strcmp(chargeA, "") == 0)
			{
				strcpy(chargeA, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeB, "") == 0)
			{
				strcpy(chargeB, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeC, "") == 0)
			{
				strcpy(chargeC, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeD, "") == 0)
			{
				strcpy(chargeD, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeE, "") == 0)
			{
				strcpy(chargeE, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeF, "") == 0)
			{
				strcpy(chargeF, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeG, "") == 0)
			{
				strcpy(chargeG, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeH, "") == 0)
			{
				strcpy(chargeH, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeI, "") == 0)
			{
				strcpy(chargeI, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeJ, "") == 0)
			{
				strcpy(chargeJ, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeK, "") == 0)
			{
				strcpy(chargeK, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeL, "") == 0)
			{
				strcpy(chargeL, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeM, "") == 0)
			{
				strcpy(chargeM, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeN, "") == 0)
			{
				strcpy(chargeN, "|| Eluding Police On Foot || ");
			}
			else if (strcmp(chargeO, "") == 0)
			{
				strcpy(chargeO, "|| Eluding Police On Foot || ");
			}
			*ptr_cCount = *ptr_cCount + 1;
			*ptr_fine = *ptr_fine + ELUDING_POLICE_ON_FOOT_FINE;
			*ptr_jailTime = *ptr_jailTime + ELUDING_POLICE_ON_FOOT_JAIL;
			break;
		...
		case 18:
			...
			*ptr_jailTime = *ptr_jailTime + MISUSE_OF_911_JAIL;
			break;
		...
		case 22:
			...
			*ptr_jailTime = *ptr_jailTime + FAILURE_TO_PROVIDE_DRIVERS_LICENSE_JAIL;
			break;

		case 23:
			//Intent to Manufacturer
			if (strcmp(chargeA, "") == 0)
			{
				strcpy(chargeA, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeB, "") == 0)
			{
				strcpy(chargeB, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeC, "") == 0)
			{
				strcpy(chargeC, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeD, "") == 0)
			{
				strcpy(chargeD, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeE, "") == 0)
			{
				strcpy(chargeE, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeF, "") == 0)
			{
				strcpy(chargeF, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeG, "") == 0)
			{
				strcpy(chargeG, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeH, "") == 0)
			{
				strcpy(chargeH, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeI, "") == 0)
			{
				strcpy(chargeI, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeJ, "") == 0)
			{
				strcpy(chargeJ, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeK, "") == 0)
			{
				strcpy(chargeK, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeL, "") == 0)
			{
				strcpy(chargeL, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeM, "") == 0)
			{
				strcpy(chargeM, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeN, "") == 0)
			{
				strcpy(chargeN, "|| Intent to Manufacturer || ");
			}
			else if (strcmp(chargeO, "") == 0)
			{
				strcpy(chargeO, "|| Intent to Manufacturer || ");
			}
			*ptr_cCount = *ptr_cCount + 1;
			*ptr_fine = *ptr_fine + INTENT_TO_MANUFACTURER_FINE;
			*ptr_jailTime = *ptr_jailTime + INTENT_TO_MANUFACTURER_JAIL;
	...
	*ptr_dirtyMoney = 0;
	...
	do
	{
		printf(
			...
			"\n| 4. Reckless Driving                          |"
			"\n| 5. Reckless Driving While Evading            |"
			...
			"\n| 18. Level 3 Illegal Weapon                   |"
			"\n| 19. Unarmed GTA                              |"
			"\n| 20. Armed GTA                                |"
			"\n| 21. Extortion                                |"
			"\n| 22. Bootleg Alcohol                          |"
			"\n| 23. Gang Enhancment 2                        |"
			"\n| 24. Driving With Suspended License           |"
			"\n|                                              |"
			"\n| ");
		SetConsoleTextAttribute(hConsole, FOREGROUND_BLUE | FOREGROUND_INTENSITY);
		printf("0. BACK                                      ");
		...
		case 5:
			...
			if (strcmp(chargeA, "") == 0)
			{
				strcpy(chargeA, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeB, "") == 0)
			{
				strcpy(chargeB, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeC, "") == 0)
			{
				strcpy(chargeC, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeD, "") == 0)
			{
				strcpy(chargeD, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeE, "") == 0)
			{
				strcpy(chargeE, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeF, "") == 0)
			{
				strcpy(chargeF, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeG, "") == 0)
			{
				strcpy(chargeG, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeH, "") == 0)
			{
				strcpy(chargeH, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeI, "") == 0)
			{
				strcpy(chargeI, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeJ, "") == 0)
			{
				strcpy(chargeJ, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeK, "") == 0)
			{
				strcpy(chargeK, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeL, "") == 0)
			{
				strcpy(chargeL, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeM, "") == 0)
			{
				strcpy(chargeM, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeN, "") == 0)
			{
				strcpy(chargeN, "|| Reckless Driving While Evading || ");
			}
			else if (strcmp(chargeO, "") == 0)
			{
				strcpy(chargeO, "|| Reckless Driving While Evading || ");
			}
			*ptr_cCount = *ptr_cCount + 1;
		...
		case 17:
			...
			if (strcmp(chargeA, "") == 0)
			{
				strcpy(chargeA, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeB, "") == 0)
			{
				strcpy(chargeB, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeC, "") == 0)
			{
				strcpy(chargeC, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeD, "") == 0)
			{
				strcpy(chargeD, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeE, "") == 0)
			{
				strcpy(chargeE, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeF, "") == 0)
			{
				strcpy(chargeF, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeG, "") == 0)
			{
				strcpy(chargeG, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeH, "") == 0)
			{
				strcpy(chargeH, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeI, "") == 0)
			{
				strcpy(chargeI, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeJ, "") == 0)
			{
				strcpy(chargeJ, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeK, "") == 0)
			{
				strcpy(chargeK, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeL, "") == 0)
			{
				strcpy(chargeL, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeM, "") == 0)
			{
				strcpy(chargeM, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeN, "") == 0)
			{
				strcpy(chargeN, "|| Failure To Appear || ");
			}
			else if (strcmp(chargeO, "") == 0)
			{
				strcpy(chargeO, "|| Failure To Appear || ");
			}
			*ptr_cCount = *ptr_cCount + 1;
			*ptr_fine = *ptr_fine + FAILURE_TO_APPEAR_FINE;
			*ptr_jailTime = *ptr_jailTime + FAILURE_TO_APPEAR_JAIL;
			break;
...
void manuallySet(int *ptr_fine, int *ptr_jailTime, char chargeA[50], char chargeB[50], char chargeC[50], char chargeD[50], char chargeE[50], char chargeF[50], char chargeG[50], char chargeH[50], char chargeI[50], char chargeJ[50], char chargeK[50], char chargeL[50], char chargeM[50], char chargeN[50], char chargeO[50], int *ptr_cCount, int *ptr_jail)
{
	//Color Stuff
	HANDLE hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
	CONSOLE_SCREEN_BUFFER_INFO consoleInfo;
	...
	do
	{
		...
		case 1:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeA, "|| Broken Head / Tail Light || "))
			{
				*ptr_fine = *ptr_fine - BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			}
			...
			if (!strcmp(chargeA, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeA, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeA, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeA, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 2:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeB, "|| Broken Head / Tail Light || "))
			{
				*ptr_fine = *ptr_fine - BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			}
			...
			if (!strcmp(chargeB, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeB, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeB, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeB, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 3:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeC, "|| Broken Head / Tail Light || "))
			{
				*ptr_fine = *ptr_fine - BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			}
			...
			if (!strcmp(chargeC, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeC, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeC, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeC, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 4:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeD, "|| Broken Head / Tail Light || "))
			{
				*ptr_fine = *ptr_fine - BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			}
			...
			if (!strcmp(chargeD, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeD, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeD, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeD, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 5:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeE, "|| Broken Head / Tail Light || "))
			{
				*ptr_fine = *ptr_fine - BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			}
			...
			if (!strcmp(chargeE, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeE, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeE, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeE, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 6:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeF, "|| Broken Head / Tail Light || "))
			{
				*ptr_fine = *ptr_fine - BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			}
			...
			if (!strcmp(chargeF, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeF, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeF, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeF, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 7:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeG, "|| Broken Head / Tail Light || "))
			{
				*ptr_fine = *ptr_fine - BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			}
			...
			if (!strcmp(chargeG, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeG, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeG, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeG, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 8:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeH, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeH, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeH, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeH, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 9:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeI, "|| Broken Head / Tail Light || "))
			{
				*ptr_fine = *ptr_fine - BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			}
			...
			if (!strcmp(chargeI, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeI, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeI, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeI, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 10:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeJ, "|| Broken Head / Tail Light || "))
			{
				*ptr_fine = *ptr_fine - BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			}
			...
			if (!strcmp(chargeJ, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeJ, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeJ, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeJ, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 11:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeK, "|| Broken Head / Tail Light || "))
			{
				*ptr_fine = *ptr_fine - BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			}
			...
			if (!strcmp(chargeK, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeK, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeK, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeK, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 12:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeL, "|| Broken Head / Tail Light || "))
			{
				*ptr_fine = *ptr_fine - BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			}
			...
			if (!strcmp(chargeL, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeL, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeL, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeL, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 13:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeM, "|| Broken Head / Tail Light || "))
			{
				*ptr_fine = *ptr_fine - BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			}
			...
			if (!strcmp(chargeM, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeM, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeM, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeM, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 14:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeN, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeN, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeN, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeN, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
		...
		case 15:
			...
			*ptr_removed++;
			...
			if (!strcmp(chargeO, "|| Broken Head / Tail Light || "))
			{
				*ptr_fine = *ptr_fine - BROKEN_HEADLIGHTS_TAIL_LIGHT_FINE;
			}
			...
			if (!strcmp(chargeO, "|| Eluding Police On Foot || "))
			{
				*ptr_fine = *ptr_fine - ELUDING_POLICE_ON_FOOT_FINE;
				*ptr_jailTime = *ptr_jailTime - ELUDING_POLICE_ON_FOOT_JAIL;
			}
			...
			if (!strcmp(chargeO, "|| Intent to Manufacturer || "))
			{
				*ptr_fine = *ptr_fine - INTENT_TO_MANUFACTURER_FINE;
				*ptr_jailTime = *ptr_jailTime - INTENT_TO_MANUFACTURER_JAIL;
			}
			...
			if (!strcmp(chargeO, "|| Reckless Driving While Evading || "))
			{
				*ptr_fine = *ptr_fine - RECKLESS_DRIVING_WHILE_EVADING_FINE;
				*ptr_jailTime = *ptr_jailTime - RECKLESS_DRIVING_WHILE_EVADING_JAIL;
			}
			...
			if (!strcmp(chargeO, "|| Failure To Appear || "))
			{
				*ptr_fine = *ptr_fine - FAILURE_TO_APPEAR_FINE;
				*ptr_jailTime = *ptr_jailTime - FAILURE_TO_APPEAR_JAIL;
			}
	...
	do
	{
		...
		if (alertCode == 3) {
			...
			case 1:
				...
				else if (*ptr_fine > MAX_FINE_AMOUNT)
				{
					printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n FINE COMMAND:");
					SetConsoleTextAttribute(hConsole, BACKGROUND_BLUE | BACKGROUND_INTENSITY);
					printf("\n-----------------------------------------------------------------------------------------------");
					SetConsoleTextAttribute(hConsole, saved_attributes);
					printf("\n/fine %d %d %s%s%s%s%s%s%s%s%s%s%s%s%s%s%sISSUED: %02d/%02d/%d \n", *ptr_id, MAX_FINE_AMOUNT, chargeA, chargeB, chargeC, chargeD, chargeE, chargeF, chargeG, chargeH, chargeI, chargeJ, chargeK, chargeL, chargeM, chargeN, chargeO, month, day, year);
					SetConsoleTextAttribute(hConsole, BACKGROUND_BLUE | BACKGROUND_INTENSITY);
					printf("-----------------------------------------------------------------------------------------------");
					SetConsoleTextAttribute(hConsole, saved_attributes);
					...
					/////////////////////////////////////////////Copy to clipboard
					char codeToCopy[420];
					sprintf(codeToCopy, "/fine %d %d %s%s%s%s%s%s%s%s%s%s%s%s%s%s%sISSUED: %02d/%02d/%d", *ptr_id, MAX_FINE_AMOUNT, chargeA, chargeB, chargeC, chargeD, chargeE, chargeF, chargeG, chargeH, chargeI, chargeJ, chargeK, chargeL, chargeM, chargeN, chargeO, month, day, year);
			...
			case 2:
				//jail code
				if (*ptr_jailTime <= MAX_JAIL_TIME && *ptr_cCount > 0 && *ptr_jailTime > 0 && *ptr_jailTime > 10)
				{
					printf("\n\n JAIL COMMAND:");
					SetConsoleTextAttribute(hConsole, BACKGROUND_BLUE | BACKGROUND_INTENSITY);
					printf("\n-----------------------------------------------------------------------------------------------");
				...
				if (*ptr_jailTime > MAX_JAIL_TIME && *ptr_cCount > 0 && *ptr_jailTime > 0 && *ptr_jailTime > 10)
				{
					...
					printf("\n-----------------------------------------------------------------------------------------------");
					SetConsoleTextAttribute(hConsole, saved_attributes);
					printf("\n/jail%d %d %d %s%s%s%s%s%s%s%s%s%s%s%s%s%s%s ISSUED: %02d/%02d/%d", *ptr_jail, *ptr_id, MAX_JAIL_TIME, chargeA, chargeB, chargeC, chargeD, chargeE, chargeF, chargeG, chargeH, chargeI, chargeJ, chargeK, chargeL, chargeM, chargeN, chargeO, month, day, year);
					SetConsoleTextAttribute(hConsole, BACKGROUND_BLUE | BACKGROUND_INTENSITY);
					printf("-----------------------------------------------------------------------------------------------");
					SetConsoleTextAttribute(hConsole, saved_attributes);
					...
					/////////////////////////////////////////////Copy to clipboard
					char codeToCopy[420];
					sprintf(codeToCopy, "/jail%d %d %d %s%s%s%s%s%s%s%s%s%s%s%s%s%s%s ISSUED: %02d/%02d/%d", *ptr_jail, *ptr_id, MAX_JAIL_TIME, chargeA, chargeB, chargeC, chargeD, chargeE, chargeF, chargeG, chargeH, chargeI, chargeJ, chargeK, chargeL, chargeM, chargeN, chargeO, month, day, year);
